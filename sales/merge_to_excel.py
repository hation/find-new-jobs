...
def main():
    platforms = ["didi", "meituan", "anti", "quark", "bytedance", "tencent", "lenovo", "inspur"]
    all_rows = []
    per_platform = {}
...
PLATFORM_NAMES = {"didi": "滴滴", "meituan": "美团", "anti": "蚂蚁", "quark": "夸克", "bytedance": "字节跳动", "tencent": "腾讯", "lenovo": "联想", "inspur": "浪潮"}
